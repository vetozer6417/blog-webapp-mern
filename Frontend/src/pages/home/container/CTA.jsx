...
const CTA = () => {
  return (
    <>
        ...
        preserveAspectRatio="none" //expand when bigger windows
        ...
        <section className='relative bg-dark-hard px-5'>
            <div className='container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center'>
                <div className='col-span-12 lg:col-span-6'>
                    ...
                    <div className='w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-3 lg:mx-0'>
                        <input type="email" placeholder='Your Email' className='px-4 py-3 rounded-lg w-full placeholder:text-dark-light focus:outline-primary'/>
                ...
                <div className='col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last'>
                    <div className='w-3/4 mx-auto relative'>
                        ...
                        <div className='w-1/2 h-1/2 bg-white rounded-lg absolute opacity-[.06] -bottom-[10%] -left-[8%]'></div>
